...
## Corpus Check
- 392 files · ~353,788 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6270 nodes · 11148 edges · 328 communities (317 shown, 11 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 585 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14c225df`
...
3. `Command` - 158 edges
4. `AudioEngine` - 75 edges
5. `AudioFileData` - 65 edges
6. `Sampler` - 61 edges
7. `AudioBufferPool` - 59 edges
...
## Communities (328 total, 11 thin omitted)
...
### Community 5 - "Channel"
Cohesion: 0.03
Nodes (76): AudioAsset, absolutePath, channelCount, contentHash, embedded, frameCount, id, relativePath (+68 more)
...
Cohesion: 0.07
Nodes (10): string, vector, Command, execute, id, name, undo, string (+2 more)

### Community 12 - "PluginInstanceManager"
Cohesion: 0.04
Nodes (50): clap_plugin_entry_t, Held, Library, ClapLibrary, entry_, factory_, library_, clap_plugin_factory_t (+42 more)

### Community 13 - "DynamicsEffects.cpp"
Cohesion: 0.15
Nodes (21): dbToGain(), coefficientFor(), prepare, process, FrameCount, SampleRate, size_t, prepare (+13 more)
...
Cohesion: 0.10
Nodes (25): FrameCount, FramePosition, size_t, TempoMap, atomic, size_t, TempoMap, uint32_t (+17 more)
...
Cohesion: 0.07
Nodes (42): EntityId, invalidValue, friend, size_t, IdGenerator, std::hash<incdaw::project::EntityId>, colourForIndex(), size_t (+34 more)
...
Cohesion: 0.06
Nodes (31): CompressorEffect, envelope_, noKeyInput, reduction_, sampleRate_, GateEffect, gain_, holdLeft_ (+23 more)
...
### Community 33 - "atomic"
Cohesion: 0.06
Nodes (16): array, thread_, unordered_map, atomic, mutex, MidiBuffer, Instrument, activeVoiceCount (+8 more)
...
Cohesion: 0.07
Nodes (29): CompiledProjectGraph, automation, builtInserts, builtSlots, channels, channelStrips, error, graph (+21 more)
...
### Community 47 - "BuiltinInstrumentInfo"
Cohesion: 0.22
...
Cohesion: 0.21
Nodes (19): size_t, string, escapeInto(), formatDouble(), asString, contains, dumpTo, set (+11 more)
...
Cohesion: 0.10
Nodes (29): AppSettings, appearance, audio, currentVersion, fromJson, load, midiClockRole, midiInputIdentifiers (+21 more)
...
Cohesion: 0.09
Nodes (12): FrameCount, friend, uint8_t, MidiMessage, data1, data2, frameOffset, status (+4 more)
...
Cohesion: 0.12
Nodes (20): allocate, FrameCount, size_t, FramePosition, Sample, size_t, vector, drive() (+12 more)
...
Cohesion: 0.05
Nodes (46): BitDepth, int64_t, path, shared_ptr, size_t, string, uintmax_t, Entry (+38 more)
...
Cohesion: 0.05
Nodes (28): MidiBuffer, TempoMap, AudioBufferPool, channelPointers_, reset, samples_, FrameCount, Sample (+20 more)
...
### Community 95 - "MidiEvent"
Cohesion: 0.04
Nodes (52): AutomationCurve, AddNoteCommand, channel_, execute, index_, note_, pattern_, size_t (+44 more)
...
Cohesion: 0.14
Nodes (12): AudioBufferView, channels_, frames_, offset_, FrameCount, Sample, size_t, FrameCount (+4 more)
...
Cohesion: 0.13
Nodes (27): appendF64(), appendU32(), BuiltinEffect, BuiltinEffect::BuiltinEffect(), decodeState, loadState, saveState, setParameter (+19 more)
...
Cohesion: 0.11
Nodes (30): CFStringRef, MIDIClientRef, MIDIEndpointRef, MIDIObjectRef, MIDIPacketList, MIDIPortRef, CoreMidiDevice, callback_ (+22 more)
...
### Community 121 - "ScratchDirectory"
Cohesion: 0.33
...
### Community 123 - "Node"
Cohesion: 0.05
Nodes (18): Node, process, ParameterSink, StateIO, ConstantSourceInsert, level_, function, InsertFactory (+10 more)
...
Cohesion: 0.05
Nodes (54): execute, undo, AutomationPoint, vector, findLane(), execute, undo, sortPoints() (+46 more)
...
Cohesion: 0.20
Nodes (16): AudioBufferList, AudioTimeStamp, OSStatus, captureFrom, inputProcTrampoline, ioProcTrampoline, renderInto, uint64_t (+8 more)
...
### Community 134 - "sumInputsInto"
Cohesion: 0.11
Nodes (19): size_t, sumInputsInto(), prepare, process, FrameCount, Sample, SampleRate, size_t (+11 more)
...
Cohesion: 0.12
Nodes (16): MidiClockRole, atomic, FramePosition, int64_t, Tick, uint64_t, MidiClockGenerator, expectedFrame_ (+8 more)
...
### Community 141 - "ProcessContext"
Cohesion: 0.12
Nodes (16): FrameCount, FramePosition, MidiBuffer, SampleRate, size_t, ProcessContext, frameCount, inputCount (+8 more)
...
Cohesion: 0.27
Nodes (6): path, string, noteAtZero(), ScratchDirectory, path, writeTestWav()
...
Cohesion: 0.25
Nodes (7): Fixture, channel, pattern, project, trackA, trackB, note()

### Community 192 - "ParameterFixture"
Cohesion: 0.13
Nodes (16): anyNonZero(), pair, ParameterSink, Sample, TempoMap, uint32_t, vector, ParameterFixture (+8 more)
...
### Community 198 - "TrackCommands.cpp"
Cohesion: 0.18
...
### Community 206 - "SetInstrumentParameterCommand"
Cohesion: 0.17
...
Cohesion: 0.22
Nodes (10): findChannel, arrangementEndFrames(), FrameCount, path, TempoMap, uint64_t, DitherSource, state_ (+2 more)
...
### Community 232 - "MoveClipsCommand"
Cohesion: 0.18
...
### Community 234 - "RemoveChannelCommand"
Cohesion: 0.18
...
Cohesion: 0.25
Nodes (7): uint64_t, uint8_t, TimestampedMidiMessage, data1, data2, hostTimeNanos, status

### Community 238 - "ChannelCommands.cpp"
Cohesion: 0.24
...
### Community 240 - "SetChannelInstrumentCommand"
Cohesion: 0.18
...
### Community 246 - "SetChannelVolumeCommand"
Cohesion: 0.18
...
### Community 251 - "ScratchDirectory"
Cohesion: 0.33
Nodes (4): path, string, ScratchDirectory, path

### Community 252 - "ScratchDirectory"
Cohesion: 0.33
Nodes (4): path, string, ScratchDirectory, path
...
Cohesion: 0.29
Nodes (10): FrameCount, MidiBuffer, size_t, TempoMap, Tick, uint8_t, emitPositionBracket, generate (+2 more)
...
### Community 257 - "AddChannelCommand"
Cohesion: 0.20
...
### Community 267 - "RemoveClipsCommand"
Cohesion: 0.20
...
### Community 270 - "SplitClipCommand"
Cohesion: 0.20
...
### Community 304 - "SetChannelMutedCommand"
Cohesion: 0.25
Nodes (5): SetChannelMutedCommand, channelId_, execute, muted_, undo

### Community 305 - "SequencedNote"
Cohesion: 0.16
Nodes (14): SequencedNote, channel, key, lengthTicks, startTick, velocity, Tick, vector (+6 more)

### Community 306 - "SetChannelSoloedCommand"
Cohesion: 0.25
...
### Community 318 - "AutomationTests.cpp"
Cohesion: 0.38
Nodes (4): AutomationPoint, Tick, enginePoint(), modelPoint()

### Community 319 - "compileProjectGraph"
Cohesion: 0.29
Nodes (6): ParameterSink, compileProjectGraph(), InstrumentFactory, TempoMap, defaultInstrumentFactory(), isAudible()

### Community 320 - "InsertFixture"
Cohesion: 0.29
...
## Knowledge Gaps
- **1722 isolated node(s):** `currentVersion`, `audio`, `openInputAtLaunch`, `midiInputIdentifiers`, `midiOutputIdentifier` (+1717 more)
...
- **Why does `EntityId` connect `EntityId` to `MixerCommands.cpp`, `AddChannelCommand`, `NoteCommands.cpp`, `WriteAutomationCommand`, `Channel`, `PatternCommands.cpp`, `DuplicateClipsCommand`, `Fixture`, `SplitClipCommand`, `ConnectMixerCommand`, `AddInsertCommand`, `RemoveSamplerZoneCommand`, `LoadSampleCommand`, `AddMarkerCommand`, `capturePluginState`, `ArpeggiateNotesCommand`, `EditFixture`, `compileArrangement`, `StretchAssetCommand`, `NudgeChordCommand`, `SidechainFixture`, `string`, `InsertAudioCommand`, `SetChannelStepKeyCommand`, `AddPatternClipCommand`, `RemoveTrackCommand`, `RenameTrackCommand`, `SetChannelMutedCommand`, `MidiImportResult`, `EditAssetRegionCommand`, `SetChannelSoloedCommand`, `AddSamplerZoneCommand`, `CountingCommand`, `AddTrackCommand`, `ImportAudioClipCommand`, `AudioAssetImport`, `SetTrackMutedCommand`, `Fixture`, `AutomationFixture`, `Fixture`, `Fixture`, `GraphCompileOptions`, `InsertFixture`, `ParameterFixture`, `Clip`, `ChannelRackTests.cpp`, `ImpulseNode`, `read`, `AddMidiMappingCommand`, `TrackCommands.cpp`, `ChannelSamplerZone`, `SetInstrumentParameterCommand`, `SetSamplerZoneCommand`, `MintedAsset`, `AutomationWriteSession`, `InsertRecordedTakeCommand`, `CompiledProjectGraph`, `RenderOptions`, `renderProject`, `MidiEvent`, `PlaylistModel`, `ClipCommands.cpp`, `RemoveChannelCommand`, `ChannelCommands.cpp`, `load`, `SetChannelInstrumentCommand`, `SliceAssetCommand`, `SetChannelVolumeCommand`, `Project`, `SendFixture`, `SplitFixture`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `MixerCommands.cpp`, `AddChannelCommand`, `NoteCommands.cpp`, `WriteAutomationCommand`, `Channel`, `PatternCommands.cpp`, `DuplicateClipsCommand`, `Fixture`, `Fixture`, `RemoveClipsCommand`, `SplitClipCommand`, `ConnectMixerCommand`, `AddInsertCommand`, `RemoveSamplerZoneCommand`, `AddMarkerCommand`, `EntityId`, `ArpeggiateNotesCommand`, `capturePluginState`, `compileArrangement`, `EditFixture`, `CommandRegistry`, `SidechainFixture`, `string`, `AddPatternClipCommand`, `SetChannelStepKeyCommand`, `RenameTrackCommand`, `CompiledProjectGraph`, `SetChannelMutedCommand`, `SetChannelSoloedCommand`, `SetTempoCommand`, `SetClipMutedCommand`, `AddTrackCommand`, `SetTrackMutedCommand`, `AudioAssetImport`, `CountingCommand`, `Fixture`, `AutomationFixture`, `Fixture`, `compileProjectGraph`, `renderArrangement`, `Fixture`, `InsertFixture`, `Clip`, `ImpulseNode`, `ParameterFixture`, `read`, `AddMidiMappingCommand`, `TrackCommands.cpp`, `SetInstrumentParameterCommand`, `SetSamplerZoneCommand`, `InsertRecordedTakeCommand`, `AudioBufferPool`, `renderProject`, `MidiEvent`, `exportArrangement`, `PlaylistModel`, `ClipCommands.cpp`, `RemoveChannelCommand`, `ChannelCommands.cpp`, `load`, `SetChannelInstrumentCommand`, `AutomationProbe`, `SetChannelVolumeCommand`, `SplitFixture`, `SendFixture`, `ResizeClipsCommand`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `Node` connect `Node` to `ConstantNode`, `AudioClipNode`, `PluginInstanceManager`, `ProcessContext`, `CompiledGraph`, `GainNode`, `SineOscillatorNode`, `EntityId`, `BuiltinEffectTests.cpp`, `BuiltinEffectInfo`, `Sample`, `GraphBuilder`, `DelayLineNode`, `atomic`, `InstrumentNode`, `LatentProcessorNode`, `CompiledProjectGraph`, `PluginParameterInfo`, `MetronomeNode`, `renderNode`, `AutomationTests.cpp`, `compileProjectGraph`, `ImpulseNode`, `HostedPlugin`, `MidiMapNode`, `processThrough`, `ImpulseNode`, `BuiltinEffect`, `InputMonitorNode`, `MixerStripNode`?**
...
- **Should `MixerCommands.cpp` be split into smaller, more focused modules?**
  _Cohesion score 0.026798598227169654 - nodes in this community are weakly interconnected._
