...
## Corpus Check
- 261 files · ~197,052 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4177 nodes · 7346 edges · 219 communities (216 shown, 3 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 350 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f4fbe592`
...
## Communities (219 total, 3 thin omitted)
...
Cohesion: 0.08
Nodes (39): execute, clampTempo(), FramePosition, SampleRate, Tick, vector, FramePosition, friend (+31 more)
...
Cohesion: 0.08
Nodes (47): SetChannelOutputCommand, channelId_, execute, mixerNode_, previous_, undo, EntityId, invalidValue (+39 more)
...
Cohesion: 0.03
Nodes (53): AddMixerNodeCommand, execute, index_, minted_, node_, type_, undo, MixerNodeType (+45 more)

### Community 67 - "AudioBufferView"
Cohesion: 0.19
Nodes (8): AudioBufferView, channels_, frames_, offset_, FrameCount, Sample, size_t, processThrough()

### Community 68 - "AutomationLane"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (38): INCDAW — Changelog, Phase 0 — Research and architecture — 2026-08-14, Phase 10 — Mixer, routing and delay compensation — 2026-08-14, Phase 11a — Automation: the generic subsystem — 2026-08-15, Phase 11b — Automation placement and recording — 2026-08-15, Phase 12 (part 1) — WAV codec — 2026-08-15, Phase 12 (part 2) — Input capture and recording — 2026-08-15, Phase 12 (part 3) — Recording lands in the timeline — 2026-08-15 (+30 more)
...
Cohesion: 0.09
Nodes (22): NSApplicationDelegate, NSObject, NSScrollView, NSSegmentedControl, NSSplitView, NSTextField, NSWindow, NSView (+14 more)
...
Cohesion: 0.05
Nodes (51): int64_t, path, shared_ptr, size_t, string, Entry, mutex, string (+43 more)

### Community 100 - "BuiltinEffect"
Cohesion: 0.11
Nodes (14): BuiltinEffect, values_, EffectParameter, defaultValue, id, maxValue, minValue, name (+6 more)
...
Cohesion: 0.20
Nodes (16): Applier, Entry, string, uint32_t, vector, Entry, size_t, vector (+8 more)
...
Cohesion: 0.08
Nodes (10): vector, Command, execute, id, name, undo, string, mutex (+2 more)
...
Cohesion: 0.12
Nodes (20): allocate, FrameCount, size_t, FramePosition, FrameCount, Sample, vector, renderBlock() (+12 more)
...
### Community 187 - "PluginParameterInfo"
Cohesion: 0.20
...
### Community 194 - "PluginSlot"
Cohesion: 0.33
Nodes (5): PluginSlot, bypassed, id, plugin, stateFile
...
### Community 196 - "PatternTests.cpp"
Cohesion: 0.53
...
### Community 198 - "OrderRecordingNode"
Cohesion: 0.40
...
Cohesion: 0.22
Nodes (9): string, ProjectMetadata, artist, comment, created, createdWith, lastSavedWith, modified (+1 more)
...
## Knowledge Gaps
- **1252 isolated node(s):** `streams_`, `enabled_`, `noRow`, `layout_`, `id` (+1247 more)
...
- **What is the exact relationship between `Time Stretching / Pitch Architecture` and `Open Decisions`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Project` connect `Project` to `AutomationProbe`, `PatternCommands.cpp`, `RemoveTrackCommand`, `CountingCommand`, `InsertFixture`, `PlaylistModel.cpp`, `AddInsertCommand`, `CompiledProjectGraph`, `CommandRegistry`, `RemoveClipsCommand`, `TempoMap`, `ClipCommands.cpp`, `ResizeClipsCommand`, `AddNoteCommand`, `RemoveMixerNodeCommand`, `InsertRecordedTakeCommand`, `capturePluginState`, `Clip`, `NoteCommands.cpp`, `MixerNode`, `ParameterFixture`, `LoadSampleCommand`, `IdGenerator`, `Pattern`, `Fixture`, `AutomationCommands.cpp`, `load`, `renderArrangement`, `PluginStateTests.cpp`, `RemoveAutomationLaneCommand`, `AudioEditCommands.cpp`, `EditFixture`, `AudioAsset`, `MixerCommands.cpp`, `AutomationFixture`, `AutomationLane`, `compileArrangement`, `Fixture`, `Fixture`, `DelayLineNode`, `Channel`, `SetClipMutedCommand`, `string`, `ChannelCommands.cpp`, `DuplicateClipsCommand`, `PlaylistView.mm`, `ConnectMixerCommand`, `Command`, `Track`, `AddAutomationLaneCommand`?**
