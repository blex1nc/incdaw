# Graph Report - kalindan-devam-f7d82f  (2026-08-16)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 4514 nodes · 7905 edges · 240 communities (232 shown, 8 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 383 edges (avg confidence: 0.82)
...
## Communities (240 total, 8 thin omitted)
...
### Community 7 - "RemoveTrackCommand"
Cohesion: 0.05
Nodes (40): AddTrackCommand, execute, index_, minted_, track_, undo, RemovedClip, size_t (+32 more)

### Community 8 - "CommandRegistry"
Cohesion: 0.06
Nodes (40): CommandPtr, CommandRegistry, actions_, clearHistory, execute, executeMerging, findAction, invoke (+32 more)
...
### Community 11 - "PlaylistModel"
Cohesion: 0.07
Nodes (42): Rect, size_t, Tick, vector, size_t, Tick, vector, Viewport (+34 more)

### Community 12 - "Project"
Cohesion: 0.06
Nodes (29): execute, undo, findNode(), execute, undo, execute, undo, Project (+21 more)
...
### Community 16 - "ProcessContext"
Cohesion: 0.09
Nodes (27): dbToGain(), sumInputsInto(), coefficientFor(), process, size_t, process, process, linkedPeakAt() (+19 more)
...
### Community 18 - "EntityId"
Cohesion: 0.11
Nodes (28): EntityId, invalidValue, friend, size_t, IdGenerator, std::hash<incdaw::project::EntityId>, size_t, operator==() (+20 more)

### Community 19 - "InstrumentNode"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (27): clap_plugin_gui_t, clap_plugin_state_t, ParamEvent, size, ClapInstance, editorOpen_, gui_, hasEditor (+19 more)

### Community 41 - "AddInsertCommand"
Cohesion: 0.08
Nodes (17): AddInsertCommand, minted_, mixerNode_, plugin_, slot_, size_t, string, RemoveInsertCommand (+9 more)

### Community 42 - "AudioDeviceConfig"
Cohesion: 0.08
...
### Community 70 - "InsertRecordedTakeCommand"
Cohesion: 0.10
...
### Community 73 - "LoadSampleCommand"
Cohesion: 0.11
...
### Community 79 - "-applicationDidFinishLaunching"
Cohesion: 0.12
...
### Community 82 - "AutomationTests.cpp"
Cohesion: 0.14
...
### Community 98 - "makeHeavyProject"
Cohesion: 0.17
Nodes (15): channels_, findMixerNode, ids_, metadata_, string, projectWithMasterInsert(), makePopulatedProject(), makeLargeProject() (+7 more)

### Community 99 - "SamplerTests.cpp"
Cohesion: 0.18
...
### Community 105 - "compileArrangement"
Cohesion: 0.26
...
### Community 121 - "SamplerWiringTests.cpp"
Cohesion: 0.19
...
### Community 124 - "AddChannelCommand"
Cohesion: 0.15
...
### Community 135 - "ChannelCommands.cpp"
Cohesion: 0.19
...
### Community 137 - "AutomationNode"
Cohesion: 0.18
Nodes (6): AutomationNode, bindings_, tempoMap_, Binding, size_t, vector

### Community 138 - "Channel"
Cohesion: 0.15
Nodes (13): Channel, colour, id, instrument, instrumentStateFile, muted, name, outputMixerNode (+5 more)

### Community 139 - "MixerNode"
Cohesion: 0.15
Nodes (13): MixerNodeType, uint32_t, MixerNode, colour, id, inserts, muted, name (+5 more)

### Community 140 - "ChannelRackView.mm"
Cohesion: 0.26
...
### Community 141 - "RecordingPlacementTests.cpp"
Cohesion: 0.21
...
### Community 163 - "RemoveChannelCommand"
Cohesion: 0.20
...
### Community 165 - "RemoveClipsCommand"
Cohesion: 0.20
...
### Community 179 - "RecentProjects"
Cohesion: 0.31
Nodes (7): string, vector, size_t, RecentProjects, maximumCount, updated, without

### Community 180 - "ScratchDirectory"
Cohesion: 0.33
Nodes (4): path, string, ScratchDirectory, path

### Community 181 - "MidiMapNode"
Cohesion: 0.25
Nodes (5): Binding, size_t, vector, MidiMapNode, bindings_

### Community 182 - "exportArrangement"
Cohesion: 0.25
Nodes (7): size_t, notes_, path, Result, uint64_t, exportArrangement(), importAsPattern()

### Community 183 - "Pattern"
Cohesion: 0.12
Nodes (18): size_t, Tick, vector, noteAtStep(), execute, undo, vector, Pattern (+10 more)

### Community 184 - "ParameterFixture"
Cohesion: 0.33
Nodes (4): ParameterFixture, pattern, project, tempo

### Community 186 - "SetChannelMutedCommand"
Cohesion: 0.25
Nodes (5): SetChannelMutedCommand, channelId_, execute, muted_, undo

### Community 187 - "SetChannelSoloedCommand"
Cohesion: 0.25
Nodes (5): SetChannelSoloedCommand, channelId_, execute, soloed_, undo

### Community 188 - "SetClipMutedCommand"
Cohesion: 0.25
...
### Community 219 - "ImpulseNode"
Cohesion: 0.40
Nodes (3): FrameCount, ImpulseNode, at_

### Community 220 - "ScratchDirectory"
Cohesion: 0.40
Nodes (4): path, makeFakePackage(), ScratchDirectory, path

### Community 221 - "StateIO"
Cohesion: 0.40
Nodes (3): StateIO, loadState, saveState

### Community 222 - "TempoMap"
Cohesion: 0.12
Nodes (19): FramePosition, SampleRate, Segment, size_t, vector, TempoMap, noTempoChange, segments_ (+11 more)
...
## Knowledge Gaps
- **1345 isolated node(s):** `execute`, `id`, `name`, `undo`, `index_` (+1340 more)
...
- **What is the exact relationship between `Time Stretching / Pitch Architecture` and `Open Decisions`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Project` connect `Project` to `Command`, `NoteCommands.cpp`, `PatternCommands.cpp`, `WriteAutomationCommand`, `ChannelCommands.cpp`, `CommandRegistry`, `RemoveTrackCommand`, `Channel`, `PlaylistModel`, `MixerNode`, `EntityId`, `AudioAsset`, `renderArrangement`, `Fixture`, `AutomationFixture`, `ConnectMixerCommand`, `MixerTests.cpp`, `TempoMap.cpp`, `AutomationProbe`, `PluginInsertTests.cpp`, `RemoveChannelCommand`, `ClipCommands.cpp`, `RemoveClipsCommand`, `AutomationLane`, `capturePluginState`, `CompiledProjectGraph`, `SetChannelStepKeyCommand`, `DuplicateClipsCommand`, `ResizeClipsCommand`, `AddMidiMappingCommand`, `Clip`, `exportArrangement`, `Pattern`, `ParameterFixture`, `Model.h`, `SetChannelMutedCommand`, `SetChannelSoloedCommand`, `SetClipMutedCommand`, `RenderTests.cpp`, `RenameChannelCommand`, `InsertRecordedTakeCommand`, `LoadSampleCommand`, `PluginStateTests.cpp`, `load`, `TempoMap`, `makeHeavyProject`, `compileArrangement`, `EditFixture`, `SamplerWiringTests.cpp`, `write`, `AddChannelCommand`?**
