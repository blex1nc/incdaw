...
## Corpus Check
- 231 files · ~174,294 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3720 nodes · 6549 edges · 209 communities (206 shown, 3 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 296 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d334a1b6`
...
## Communities (209 total, 3 thin omitted)
...
Cohesion: 0.06
Nodes (36): AddInsertCommand, execute, minted_, mixerNode_, plugin_, slot_, undo, findNode() (+28 more)
...
### Community 22 - "Clip"
Cohesion: 0.06
Nodes (46): ClipType, Clip, colour, fadeInFrames, fadeOutFrames, gain, id, length (+38 more)
...
Cohesion: 0.10
Nodes (19): FrameCount, FramePosition, MidiBuffer, Tick, vector, size_t, Tick, uint32_t (+11 more)

### Community 33 - "InsertRecordedTakeCommand"
Cohesion: 0.06
Nodes (27): Placement, size_t, string, vector, InsertRecordedTakeCommand, asset_, assetIndex_, clipIndices_ (+19 more)

### Community 34 - "atomic"
Cohesion: 0.13
Nodes (5): atomic, MidiBuffer, mutex, allocationSize(), size_t
...
Cohesion: 0.06
Nodes (40): undo, NoteIndices, size_t, vector, execute, undo, findEvents(), execute (+32 more)
...
### Community 49 - "compileProjectGraph"
Cohesion: 0.14
Nodes (20): process, FrameCount, FramePosition, MidiBuffer, NodeIndex, SampleRate, size_t, unique_ptr (+12 more)
...
Cohesion: 0.05
Nodes (53): AutomationCurve, Emit, size_t, Tick, vector, noteAtStep(), execute, undo (+45 more)
...
### Community 69 - "TrackCommands.cpp"
Cohesion: 0.19
...
Cohesion: 0.08
Nodes (33): NoteList, size_t, Tick, vector, size_t, Tick, vector, Viewport (+25 more)
...
Cohesion: 0.06
Nodes (32): INCDAW — Changelog, Phase 0 — Research and architecture — 2026-08-14, Phase 10 — Mixer, routing and delay compensation — 2026-08-14, Phase 11a — Automation: the generic subsystem — 2026-08-15, Phase 11b — Automation placement and recording — 2026-08-15, Phase 12 (part 1) — WAV codec — 2026-08-15, Phase 12 (part 2) — Input capture and recording — 2026-08-15, Phase 12 (part 3) — Recording lands in the timeline — 2026-08-15 (+24 more)
...
Cohesion: 0.12
Nodes (4): vector, string, ParameterSink, StateIO
...
### Community 134 - "ChannelCommands.cpp"
Cohesion: 0.21
...
### Community 158 - "AddChannelCommand"
Cohesion: 0.22
...
### Community 163 - "SetChannelStepKeyCommand"
Cohesion: 0.22
...
### Community 167 - "Track"
Cohesion: 0.04
Nodes (48): Channel, colour, id, instrument, instrumentStateFile, muted, name, outputMixerNode (+40 more)

### Community 168 - "ScratchDirectory"
Cohesion: 0.29
Nodes (4): path, string, ScratchDirectory, path

### Community 169 - "AddTrackCommand"
Cohesion: 0.22
...
### Community 175 - "RemoveTrackCommand"
Cohesion: 0.22
...
Cohesion: 0.25
Nodes (5): FramePosition, ImpulseNode, latency_, position_, channel
...
### Community 188 - "SetChannelSoloedCommand"
Cohesion: 0.25
...
### Community 191 - "SetTrackMutedCommand"
Cohesion: 0.25
Nodes (5): SetTrackMutedCommand, execute, muted_, trackId_, undo

### Community 192 - "SetTrackSoloedCommand"
Cohesion: 0.25
...
Cohesion: 0.25
Nodes (6): buildParallelPaths(), unique_ptr, MixerFixture, pattern, project, tempo
...
### Community 198 - "process"
Cohesion: 0.33
Nodes (6): size, blobWrite(), process, setParameter, clap_ostream_t, uint32_t

### Community 199 - "ParameterFixture"
Cohesion: 0.33
...
### Community 201 - "AutomationTests.cpp"
Cohesion: 0.60
Nodes (4): AutomationPoint, Tick, enginePoint(), modelPoint()

### Community 202 - "ChannelRackTests.cpp"
Cohesion: 0.40
...
## Knowledge Gaps
- **1111 isolated node(s):** `streams_`, `enabled_`, `noRow`, `layout_`, `id` (+1106 more)
...
- **What is the exact relationship between `Time Stretching / Pitch Architecture` and `Open Decisions`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Project` connect `Project` to `AutomationProbe`, `PatternCommands.cpp`, `RenameTrackCommand`, `ChannelCommands.cpp`, `PlaylistModel`, `EntityId`, `CommandRegistry`, `Fixture`, `RemoveClipsCommand`, `TempoMap`, `Clip`, `RemoveChannelCommand`, `ClipCommands.cpp`, `AddNoteCommand`, `AddChannelCommand`, `capturePluginState`, `InsertRecordedTakeCommand`, `SetChannelStepKeyCommand`, `Track`, `AddTrackCommand`, `load`, `WriteAutomationCommand`, `compileProjectGraph`, `ResizeClipsCommand`, `PluginStateTests.cpp`, `SetChannelMutedCommand`, `SetChannelSoloedCommand`, `SetClipMutedCommand`, `write`, `Pattern`, `SetTrackMutedCommand`, `Command`, `SetTrackSoloedCommand`, `Fixture`, `TrackCommands.cpp`, `EditFixture`, `AutomationFixture`, `MixerFixture`, `ParameterFixture`, `Fixture`, `PluginInsertTests.cpp`, `string`, `DuplicateClipsCommand`, `ConnectMixerCommand`, `renderArrangement`, `vector`, `RemoveMixerNodeCommand`?**
