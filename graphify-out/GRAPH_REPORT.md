...
## Corpus Check
- 269 files · ~201,042 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4268 nodes · 7502 edges · 214 communities (207 shown, 7 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 359 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ccc1db62`
...
Cohesion: 0.12
Nodes (12): AudioBufferPool, channelPointers_, reset, samples_, FrameCount, Sample, size_t, unique_ptr (+4 more)
...
Cohesion: 0.07
Nodes (26): CompiledProjectGraph, automation, channels, channelStripFor, channelStrips, error, graph, insertSlots (+18 more)
...
Cohesion: 0.08
Nodes (37): RetiredGraph, AudioCaptureSink, AudioEngine, active_, anchor_, anchorVersion_, audioDeviceAboutToStart, audioDeviceStopped (+29 more)
...
Cohesion: 0.12
Nodes (15): ifstream, FrameCount, path, SampleRate, uint16_t, uint64_t, uint8_t, vector (+7 more)
...
### Community 34 - "atomic"
Cohesion: 0.16
Nodes (5): atomic, MidiBuffer, array, allocationSize(), size_t
...
Cohesion: 0.14
Nodes (22): NoteIndices, size_t, vector, execute, findEvents(), execute, undo, execute (+14 more)
...
Cohesion: 0.09
Nodes (30): Connection, NodeIndex, SampleRate, size_t, unique_ptr, GraphBuilder, addNode, analyse (+22 more)
...
### Community 68 - "Track"
Cohesion: 0.03
Nodes (60): AutomationLane, id, parameterKey, points, targetEntity, Channel, colour, id (+52 more)

### Community 69 - "Pattern"
Cohesion: 0.08
Nodes (37): AutomationCurve, Emit, AutomationPoint, curve, tension, tick, value, Tick (+29 more)
...
Cohesion: 0.08
Nodes (24): FrameCount, Sample, SampleRate, size_t, vector, InputMonitorNode, channelCount_, ring_ (+16 more)

### Community 79 - "[Unreleased]"
Cohesion: 0.05
Nodes (39): INCDAW — Changelog, Phase 0 — Research and architecture — 2026-08-14, Phase 10 — Mixer, routing and delay compensation — 2026-08-14, Phase 11a — Automation: the generic subsystem — 2026-08-15, Phase 11b — Automation placement and recording — 2026-08-15, Phase 12 (part 1) — WAV codec — 2026-08-15, Phase 12 (part 2) — Input capture and recording — 2026-08-15, Phase 12 (part 3) — Recording lands in the timeline — 2026-08-15 (+31 more)
...
Cohesion: 0.09
Nodes (24): NSApplicationDelegate, NSObject, NSScrollView, NSSegmentedControl, NSSplitView, NSString, NSTextField, NSWindow (+16 more)
...
Cohesion: 0.08
Nodes (32): Held, size_t, string, uint32_t, uint64_t, unique_ptr, vector, mutex (+24 more)
...
Cohesion: 0.12
Nodes (25): execute, undo, findNode(), execute, undo, execute, undo, Project (+17 more)
...
### Community 117 - "SampleCache"
Cohesion: 0.14
Nodes (17): int64_t, path, shared_ptr, size_t, string, Entry, mutex, string (+9 more)
...
Cohesion: 0.11
Nodes (22): allocate, FrameCount, size_t, FramePosition, Sample, vector, render(), anyNonZero() (+14 more)
...
Cohesion: 0.29
Nodes (6): size_t, FrameCount, path, shared_ptr, string, create
...
### Community 153 - "SetVelocityCommand"
Cohesion: 0.13
...
### Community 175 - "ScratchDirectory"
Cohesion: 0.33
Nodes (4): path, string, ScratchDirectory, path
...
### Community 187 - "INCDAWPatternListView"
Cohesion: 0.50
...
## Knowledge Gaps
- **1282 isolated node(s):** `streams_`, `enabled_`, `noRow`, `layout_`, `id` (+1277 more)
...
- **What is the exact relationship between `Time Stretching / Pitch Architecture` and `Open Decisions`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `EntityId` connect `EntityId` to `PatternCommands.cpp`, `RemoveTrackCommand`, `MoveNotesCommand`, `CountingCommand`, `PlaylistModel`, `RemoveInsertCommand`, `CompiledProjectGraph`, `EditAssetRegionCommand`, `ClipCommands.cpp`, `InstrumentNode`, `SetVelocityCommand`, `AddNoteCommand`, `RemoveMixerNodeCommand`, `InsertRecordedTakeCommand`, `NoteSequence`, `Clip`, `SamplerWiringTests.cpp`, `NoteCommands.cpp`, `GraphCompileOptions`, `LoadSampleCommand`, `ClipIds`, `WriteAutomationCommand`, `AutomationCommands.cpp`, `load`, `SetAutomationPointsCommand`, `AutomationWriteSession`, `AudioFileData`, `StateFixture`, `RemoveAutomationLaneCommand`, `AudioEditCommands.cpp`, `EditFixture`, `Command`, `AutomationFixture`, `Track`, `Pattern`, `PluginIdentifier`, `Fixture`, `PianoRollModel`, `DelayLineNode`, `AddMidiMappingCommand`, `PluginInsertTests.cpp`, `ChannelCommands.cpp`, `ConnectMixerCommand`, `AddPatternClipCommand`, `Project`, `AddAutomationLaneCommand`, `QuantizeNotesCommand`?**
