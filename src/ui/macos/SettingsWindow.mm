...
NSTextField* makeLabel(NSString* text, NSRect frame, BOOL heading)
{
    ...
    field.font          = heading ? [NSFont boldSystemFontOfSize:12.0]
                                  : [NSFont systemFontOfSize:12.0];
    field.textColor     = heading ? [NSColor secondaryLabelColor] : [NSColor labelColor];
    return field;
}
...
- (void)buildWindow
{
    ...
    _status.font      = [NSFont monospacedDigitSystemFontOfSize:11.0 weight:NSFontWeightRegular];
