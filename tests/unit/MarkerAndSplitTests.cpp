...
TEST_CASE("the v1.6 fixture still loads")
{
    const fs::path fixture = fs::path{INCDAW_FIXTURE_DIR} / "v1.6" / "Fixture.incdaw";
    ...
    CHECK(project.metadata().title == "Format v1.6 fixture");
